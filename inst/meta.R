...
metaApp <- data.frame("name" = c("gg_bar_circular_Cat.", "gg_bar_circular_CatNum.", "gg_bar_circular_facet_CatCat.", "gg_bar_polar_Cat.",
                                 ...
                                 "gg_line_facet_CatCat", "gg_line_facet_CatCatNum",
                                 "gg_line_Cat", "gg_line_multi_CatCatNum", "gg_line_multi_CatDatNum", "gg_line_multi_CatNum",
                                 ...
                                 "gg_line_point_facet_CatCat", "gg_line_point_Cat", "gg_line_point_multi_CatCatNum",
                                 "gg_line_point_multi_CatDatNum", "gg_line_point_multi_CatNum", "gg_line_point_multi_CatNumNum",
